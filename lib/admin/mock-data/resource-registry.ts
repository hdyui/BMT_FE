...
const remainingResources: AdminResourceConfig[] = [
  resource({
    module: "projects",
    path: "page-hero",
    title: "Hero trang Dự án",
    singular: "Hero trang Dự án",
    description: "Copy và ảnh content của Projects Hero; blueprint, layer và vị trí vẫn khóa trong component.",
    priority: "P1",
    kind: "singleton",
    titleField: "title",
    previewField: "desktopImage",
    sections: [
      section("content", "Nội dung", [text("title", "H1", { required: true }), textarea("description", "Mô tả"), text("ctaLabel", "CTA label"), url("ctaHref", "CTA URL")]),
      section("media", "Hình ảnh", [image("desktopImage", "Ảnh Desktop", { altKey: "desktopAlt" }), image("mobileImage", "Ảnh Mobile", { altKey: "mobileAlt" })]),
    ],
  ...
  resource({
    module: "news",
    path: "page-hero",
    title: "Hero trang Tin tức",
    singular: "Hero trang Tin tức",
    description: "Eyebrow, tiêu đề, mô tả, CTA và ảnh nội dung của News Hero.",
    priority: "P2",
    kind: "singleton",
    titleField: "title",
    previewField: "desktopImage",
    sections: [
      section("content", "Nội dung", [text("eyebrow", "Eyebrow"), text("title", "H1", { required: true }), textarea("description", "Mô tả"), text("ctaLabel", "CTA label"), url("ctaHref", "CTA URL")]),
      section("media", "Hình ảnh", [image("desktopImage", "Ảnh Desktop", { altKey: "desktopAlt" }), image("mobileImage", "Ảnh Mobile", { altKey: "mobileAlt" })]),
    ],
  ...
  resource({
    module: "quotation",
    path: "hero",
    title: "Hero trang Báo giá",
    singular: "Hero trang Báo giá",
    description: "Nội dung giới thiệu và ảnh content; toàn bộ decorative layer của banner bị khóa.",
    priority: "P1",
    kind: "singleton",
    titleField: "title",
    previewField: "mobileImage",
    sections: [
      section("content", "Nội dung", [text("eyebrow", "Eyebrow"), text("title", "H1", { required: true }), textarea("description", "Mô tả"), text("ctaLabel", "CTA label"), url("ctaHref", "CTA URL")]),
      section("media", "Hình ảnh", [image("mobileImage", "Ảnh Mobile", { altKey: "mobileAlt" })]),
    ],
    initialRecords: [record("quotation-hero", { eyebrow: "BÁO GIÁ DỊCH VỤ BMT DECOR", title: "MINH BẠCH VÀ TỐI ƯU CHI PHÍ", description: "Tham khảo báo giá các dịch vụ thiết kế, thi công, xây nhà trọn gói, cải tạo và sửa chữa nhà theo nhu cầu thực tế.", ctaLabel: "LIÊN HỆ NGAY", ctaHref: "/lien-he", mobileImage: "/images/bao-gia/mobile/quotation-hero.png", mobileAlt: "Báo giá dịch vụ BMT Decor" })],
  }),
  resource({
    module: "contacts",
    path: "hero",
    title: "Hero trang Liên hệ",
    singular: "Hero trang Liên hệ",
    description: "Nội dung, CTA và ảnh tư vấn viên; decoration và responsive positioning bị khóa.",
    priority: "P1",
    kind: "singleton",
    titleField: "title",
    previewField: "photo",
  ...
  resource({
    ...
    description: "Địa chỉ mô tả và Google Maps URL thuộc content; kích thước iframe và presentation bị khóa.",
    priority: "P2",
    kind: "singleton",
    titleField: "title",
    sections: [section("map", "Bản đồ", [text("title", "Tiêu đề hỗ trợ accessibility"), url("googleMapsUrl", "Google Maps URL", { required: true })])],
  ...
  resource({
    ...
    description: "Nội dung Hero và tiêu đề tài liệu; hiệu ứng lật trang, layer và animation bị khóa.",
    priority: "P2",
    kind: "singleton",
    titleField: "title",
    previewField: "heroImage",
    sections: [
      section("hero", "Hero", [text("title", "H1", { required: true }), text("subtitle", "Phụ đề"), textarea("description", "Mô tả"), image("heroImage", "Ảnh Hero", { altKey: "heroAlt" })]),
      section("document", "Tài liệu", [text("documentHeading", "Tiêu đề section hồ sơ")]),
    ],
    initialRecords: [record("capability-profile", { title: "HỒ SƠ NĂNG LỰC BMT DECOR", subtitle: "Khẳng định năng lực - Đồng hành kiến tạo giá trị bền vững", description: "Khám phá tổng quan về BMT Decor thông qua lĩnh vực hoạt động, đội ngũ chuyên môn, quy trình triển khai và các dự án tiêu biểu.", heroImage: "/images/capability-profile/hero-profile.webp", heroAlt: "Bộ hồ sơ năng lực BMT Decor được trưng bày trên bàn gỗ", documentHeading: "HỒ SƠ DOANH NGHIỆP" })],
  }),
  resource({
    module: "news",
    path: "featured",
  ...
  resource({
    ...
    sections: [
      section("content", "Nội dung", [text("title", "Tiêu đề", { required: true }), textarea("description", "Mô tả")]),
      section("desktop", "Ảnh Desktop", [image("desktopImage", "Ảnh Desktop", { altKey: "desktopAlt" })]),
      section("mobile", "Ảnh Mobile", [image("mobileImage", "Ảnh Mobile", { altKey: "mobileAlt" })]),
    ],
