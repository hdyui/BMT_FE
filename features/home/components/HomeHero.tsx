          ...
          >
            ...
            <div className="relative mx-auto flex h-full w-[min(1380px,calc(100%-2.5rem))] items-end pb-20 sm:pb-24 lg:pb-28">
              ...
              >
                ...
                <motion.p
                  className="mt-5 max-w-xl text-justify text-xl leading-relaxed text-white/90 [text-align-last:left] [text-justify:inter-character] max-sm:text-left max-sm:text-base"
