    ...
    >
      ...
      <div className="mx-auto w-[min(1380px,calc(100%-2.25rem))]">
        <div className="mx-auto flex flex-col items-center text-center">
          <h2
            className={`whitespace-nowrap text-4xl sm:text-5xl font-extrabold uppercase leading-none tracking-[-0.025em] text-charcoal transition-[opacity,translate] duration-900 ease-[cubic-bezier(.22,1,.36,1)] motion-reduce:translate-y-0 motion-reduce:opacity-100 ${
              isVisible
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="relative h-24 min-w-0 flex-1 sm:h-28">
                      ...
                      <div
                        className="absolute bottom-[12px] left-0 right-0 flex items-center"
                        aria-hidden="true"
                      >
                  ...
                  >
                    <h3 className="mt-16 text-[18px] font-extrabold leading-tight text-charcoal">
                      <span className="inline-block border-b border-brand pb-1">
                        {titleLead}
                      </span>{" "}
                      {titleRest.join(" ")}
                    </h3>
                    <p className="mt-3 text-justify text-xl leading-6 text-neutral-700 [text-align-last:left] [text-justify:inter-character]">
                      {description}
                    </p>
                  </div>
